About backports.shutil_which-feedstock
======================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/backports.shutil_which-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3663&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/backports.shutil_which-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `backports.shutil_which` can be installed with `conda`:
...
```
mamba install backports.shutil_which
```

It is possible to list all of the versions of `backports.shutil_which` available on your platform with `conda`:
...
```
mamba search backports.shutil_which --channel conda-forge
```
...
mamba repoquery search backports.shutil_which --channel conda-forge

# List packages depending on `backports.shutil_which`:
mamba repoquery whoneeds backports.shutil_which --channel conda-forge

# List dependencies of `backports.shutil_which`:
mamba repoquery depends backports.shutil_which --channel conda-forge
```
